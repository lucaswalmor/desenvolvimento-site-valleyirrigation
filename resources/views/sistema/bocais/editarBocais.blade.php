                ...
                <div class="tab-pane fade show active" id="cadastro" role="tabpanel" aria-labelledby="cadastro-tab">
                    ...
                    <div id="cssPreloader">
                        <div class="table mx-auto">
                            <div class="form-row justify-content-start ml-4 mt-4 telo5ce formulario-bocais-mobile">
                                <div class="col-md-2">
                                ...
                                <div class="col-md-2">
                                    ...
                                    maxlength="50"  autocomplete="off" value="{{ $bocais[0]['modelo'] }}">
                                </div>

                                <div class="col-md-2">
                                    <label for="vazao_10_psi">@lang('bocais.vazaoMetroCubico')</label>
                                    <select class="form-control" name="vazao_10_psi" id="vazao_10_psi">
                                        <option value='10' @if ($bocais[0]['vazao_10_psi'] == 10) selected @endif><b>10 PSI</b></option>
                                        <option value='15' @if ($bocais[0]['vazao_10_psi'] == 15) selected @endif><b>15 PSI</b></option>
                                        <option value='20' @if ($bocais[0]['vazao_10_psi'] == 20) selected @endif><b>20 PSI</b></option>
                                        <option value='25' @if ($bocais[0]['vazao_10_psi'] == 25) selected @endif><b>25 PSI</b></option>
                                        <option value='30' @if ($bocais[0]['vazao_10_psi'] == 30) selected @endif><b>30 PSI</b></option>
                                        <option value='40' @if ($bocais[0]['vazao_10_psi'] == 40) selected @endif><b>40 PSI</b></option>
