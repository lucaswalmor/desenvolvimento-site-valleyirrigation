...
@section('topo_detalhe')
    ...
    @section('conteudo')
        ...
        <div class="formafericao">
            ...
            <form action="{{ route('salvarBombeamento.salvar') }}" method="post" id="formdados">
                @csrf
                ...
                <div class="tab-content mt-5" id="myTabContent">
                    @for ($i = 1; $i <= $numero_bombas; $i++)
                        <div class="tab-pane fade {{ $i == 1 ? 'show active' : '' }}" id="bomba_{{ $i }}" role="tabpanel"
                            aria-labelledby="bomba_{{ $i }}">
                            <div class="col-md-12 formpivocentral">
                                ...
                                <div class="form-row justify-content-center">
                                    <div class="col-md-3 form-group telo5ce">
                                        ...
                                        <select onchange="teste({{ $i }})" onclick="selected(this.value)"
