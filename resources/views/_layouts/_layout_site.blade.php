                                    ...
                                    <ul class="group-list">
                                        ...
                                        <li class="subnavbar">
                                            ...
                                            <label for="redimensionamento">
                                                <a href="{{ route('gerenciarRedimensionamentos') }}" class='nav-link'>
                                                    <i class='fa fa-fw fa-money'></i>
                                                    @lang('redimensionamento.redimensionamento')
                                                </a>
                                            </label>
                                        </li>
                ...
                <div id="main">
                    <ul id="menu" class="nav navbar-right header-usuario">
                        ...
                        <li id="user"><img src="{{ asset('img/ico_user.png') }}" alt=""
                                class="icones"><span>Lucas</span><i class="fas fa-caret-down "></i>
                            <ul>
                                ...
                                <li><a
                                        href="{{ route('proprietarios.gerenciar') }}">@lang('sidenav.proprietarios')</a>
                                </li>
