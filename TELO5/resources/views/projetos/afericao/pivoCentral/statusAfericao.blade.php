    ...
    <div class="col-md-12 position">
        <div class="form-row justify-content-center ">
            <div class="form-group col-md-2 text-center afericao p-2">
                ...
                <div class="p-2 hoverstatusafericao" style="background-color: {{ $afericao['cor'] }} !important;">
            ...
            <div class="form-group col-md-2 text-center afericao p-2">
                ...
                <div class="p-2 hoverstatusafericao" style="background-color: {{ $emissores['cor'] }} !important;">
            ...
            <div class="form-group col-md-2 text-center afericao p-2">
                ...
                <div class="p-2 hoverstatusafericao" style="background-color: {{ $adutora['cor'] }} !important;">
            ...
            <div class="form-group col-md-2 text-center afericao p-2">
                ...
                <div class="p-2 hoverstatusafericao" style="background-color: {{ $bombeamento['cor'] }} !important;">
        ...
        <div class="form-row justify-content-center">
            <div class="form-group col-md-3 text-center afericao p-2">
                ...
                <div class="p-2 hoverstatusafericao" style="background-color: {{ $mapaOriginal['cor'] }} !important;">
            ...
            <div class="form-group col-md-4 text-center afericao p-2">
                <div>
                ...
                <div class="p-2 hoverstatusafericao" style="background-color: {{ $relVelocidade['cor'] }} !important;">
            ...
            <div class="form-group col-md-3 text-center afericao p-2">
                ...
                <div class="p-2 hoverstatusafericao" style="background-color: {{ $ftDiag['cor'] }} !important;">
