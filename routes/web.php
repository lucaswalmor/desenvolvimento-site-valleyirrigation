...
Route::group(['middleware' => 'auth', 'middleware' => 'verified'], function () {
    ...
    Route::group(['middleware' => 'assistente'], function () {
        ...
        //Rotas de item de bombeamento
        // Route::get('/afericao/pivo_central/bombeamento/cadastrarItemBombeamento', ['as' => 'itemBombeamento.cadastrar', 'uses' => 'Sistema\LevantamentoAdutoraController@cadastrarItemBombeamento']);
        Route::post('/afericao/pivo_central/bombeamento/salvarItemBombeamento', ['as' => 'salvarBombeamento.salvar', 'uses' => 'Projetos\Afericao\PivoCentral\LevantamentoAdutoraController@salvarItemBombeamento']);
