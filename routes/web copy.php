...
// Route::name('docusign_')->group(function(){
//     Route::get('docusign', 'DocusignController@index')->name('docusign');
//     Route::get('connect-docusign', 'DocusignController@connectDocusign')->name('connect');
//     Route::get('docusign/callback', 'DocusignController@callback')->name('callback');
//     Route::get('sign-document', 'DocusignController@signDocument')->name('sign');
// }); 
